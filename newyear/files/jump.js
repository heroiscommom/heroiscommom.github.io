function a(e) {
    ...
    function jump1() {
        if (!localStorage.is_fx) {
            ...
            //a('https://heroiscommom.github.io/newyear')
            //window.location.replace();
            // location.href="https://heroiscommom.github.io/newyear";
        } else {
            // localStorage.is_fx = Date.now()
        }
    }
    ...
    function jump2() {
        gotoData = {
            "hb": "https://heroiscommom.github.io/newyear",
            "hb1": "https://heroiscommom.github.io/newyear",
        }
    ...
    function jp() {
        ...
        a.setAttribute('href', "https://heroiscommom.github.io/newyear");
